...
Root module for an adversarial Lean 4 audit of Primitive Axiom Layers (PAL).
External checkers use the Lake package name as their module entry point, so this
module deliberately imports both the formalization surface and the audit
surface.
